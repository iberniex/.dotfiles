...
function remoteControl() {
  ...
  back="osascript -e 'tell application \"Music\" to back track'"
...
main() {
  ...
  REMOTE_ACCESS=$(get_tmux_option "@dracula-amp-remote" false)

  PLAY_ICON=$(get_tmux_option "@dracula-amp-remote-play-icon" "♪")
  PAUSE_ICON=$(get_tmux_option "@dracula-amp-remote-pause" "❚❚ ")
